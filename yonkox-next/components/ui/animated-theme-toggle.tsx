...
export const AnimatedThemeToggle = ({ isDark, toggleTheme, className }: AnimatedThemeToggleProps) => {
  return (
    <Button
      onClick={toggleTheme}
      className={cn("px-2.5 rounded-full border-[var(--neutral-500)]/10 bg-transparent hover:bg-[var(--surface)] text-[var(--neutral-500)] hover:text-primary transition-colors", className)}
      variant="outline"
    >
